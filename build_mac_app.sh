...
detected_modules=`$JAVA_HOME/bin/jdeps \
  ...
  --class-path "target/installer/input/libs/*" \
    target/classes/net/phybros/todofx/HelloApplication.class`
...
#manual_modules=,jdk.crypto.ec,jdk.localedata,jdk.xml.dom,java.logging,java.net.http,jdk.jsobject
...
--name TodoTxtFX \
--main-class net.phybros.todofx.AppLauncher \
--main-jar ${MAIN_JAR} \
